...
if not exist "%SDL3_DEST_FOLDER%" (
	call :DownloadAndExtractPackage https://github.com/libsdl-org/SDL/releases/download/preview-3.1.8/SDL3-devel-3.1.8-VC.zip SDL
	xcopy "%TMP_FOLDER%\SDL\SDL3-3.1.8\include\*" "%SDL3_DEST_FOLDER%\" /E /I /Y
	xcopy "%TMP_FOLDER%\SDL\SDL3-3.1.8\lib\x64\*" "%cd%\bin\"
)
